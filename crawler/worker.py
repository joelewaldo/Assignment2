...
class Worker(Thread):
    ...
    def run(self):
        while True:
            ...
            if resp.raw_response and resp.raw_response.headers and resp.raw_response.headers['content-length'] and float(resp.raw_response.headers['content-length']) > self.config.max_file_size * 1048576:
